<?php
require_once ('/var/www/html/Testing_Environment/hyper_wallet/vendor/autoload.php');
...
$username = 'restapiuser@9205791610';
$password = 'Hyperwallet@123';
$programToken = 'prg-50ccb7f0-82aa-4588-bc49-350499f3584c';
