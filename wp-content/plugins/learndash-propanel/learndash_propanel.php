...
LearnDash_Dependency_Check::get_instance()->set_message( __( 'LearnDash ProPanel requires the following plugin(s) %s be active: ', 'ld_propanel' ) );
...
register_deactivation_hook( __FILE__, 'deactivate_deactivate_learndash_propanellearndash_propanel' );
