...
<?php if ( 'quiz' == $activity->activity_type ) : ?>
	<div class="activity-item quiz">
		...
		<div class="content">
			...
			<?php else : ?>
				<strong><?php esc_html_e( 'Result:', 'ld_propanel' ); ?> </strong><?php echo ( $this->quiz_activity_is_passing( $activity ) ) ? esc_html__( 'Passed', 'ld_propanel' ) : esc_html__( 'Failed', 'ld_propanel' ); ?>.<br/>
			<?php endif; ?>
...
<?php if ( 'access' == $activity->activity_type ) : ?>
	...
	<div class="activity-item course">
		...
		<div class="content">
			<strong><?php echo sprintf( _x('Gained %s Access:', 'Gained Course Access:', 'ld_propanel' ), LearnDash_Custom_Label::get_label( 'course' ) ); ?></strong> <strong><a href="<?php echo get_permalink( $course->ID ); ?>" class="link"><?php echo $activity->post_title; ?></a></strong><br/>
		</div>
	</div>
