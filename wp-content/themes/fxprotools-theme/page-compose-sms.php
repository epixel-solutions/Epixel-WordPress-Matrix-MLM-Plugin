        ...
        <form name="compose-email" class="compose-email clearfix" method="post">
        	...
        	<div class="form-group">
        	   ...
        	   <select id="recipient_individual_type" name="recipient_individual_type" class="form-control">
        	      <option value="sms">Specified Number</option>
        	      <option value="user">User</option>
        	   </select>
        	</div>
        	<div class="form-group">
        	   <label for="recipient_individual_email">Individual Number</label>
        	   <input id="recipient_individual_email" name="recipient_individual_sms" class="form-control" />
        	</div>
        	<div class="form-group">
